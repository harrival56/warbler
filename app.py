...
app.config['SQLALCHEMY_DATABASE_URI'] = (
    os.environ.get('DATABASE_URL', 'postgresql://:5433/warbler'))
...
def like_and_unlike(msg_id):
    ...
    if liked_message in user_likes:
        g.user.likes = [like for like in user_likes if like != liked_message] #UPDATE THE G.USER.LIKE WITH ALL THE LIKE EXCEPT THE LIKED MESSAGE
    else:
